    ...
    <div class="card-body">
        <form action="{{ route('parties.store') }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6 party-sc-combo" id="party_form_sc_wrap">
                    <label class="form-label" for="party_form_sub_search">Party sub category <span class="text-danger">*</span></label>
                    <input type="hidden" name="sub_category_id" id="party_form_sub_category_id" value="{{ old('sub_category_id') }}" required>
                    <input type="text"
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-theme @error('cnic') is-invalid @enderror" id="cnic" name="cnic" value="{{ \App\Support\CnicFormat::display(old('cnic')) }}" maxlength="14" inputmode="numeric" placeholder="34012-211172-1">
                    @error('cnic')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
