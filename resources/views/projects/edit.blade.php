        ...
        <form action="{{ route('projects.update', $project) }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.0001" min="0" class="form-control form-control-theme @error('land_area') is-invalid @enderror" id="land_area" name="land_area" value="{{ old('land_area', $project->land_area) }}" placeholder="0">
                ...
                <div class="col-md-4">
                    ...
                    <select name="land_area_unit" id="land_area_unit" class="form-select form-select-theme @error('land_area_unit') is-invalid @enderror">
                        ...
                        @foreach (['acre' => 'Acre', 'kanal' => 'Kanal', 'marla' => 'Marla', 'sqft' => 'Sq ft'] as $val => $label)
                            <option value="{{ $val }}" @selected(old('land_area_unit', $project->land_area_unit) === $val)>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="field_type" id="field_type" class="form-select form-select-theme @error('field_type') is-invalid @enderror">
                        <option value="">—</option>
                        <option value="sale" @selected(old('field_type', $project->field_type) === 'sale')>Sale</option>
                        <option value="purchase" @selected(old('field_type', $project->field_type) === 'purchase')>Purchase</option>
                    </select>
