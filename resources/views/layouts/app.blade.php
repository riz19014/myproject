        ...
        <aside class="app-sidebar" id="appSidebar" aria-label="Main navigation">
            <div class="app-sidebar-inner">
                ...
                <nav class="app-sidebar-nav">
                    ...
                    <a class="app-sidebar-link {{ request()->routeIs('sale.index') || request()->routeIs('sale.files.*') || request()->routeIs('sale.records.*') || $sidebarIsSaleProject ? 'active' : '' }}" href="{{ route('sale.index') }}"><i class="bi bi-graph-up-arrow app-sidebar-link__icon" aria-hidden="true"></i><span>Sale</span></a>
                    ...
                    <a class="app-sidebar-link {{ request()->routeIs('daybook.index', 'daybook.create', 'daybook.show', 'daybook.edit', 'daybook.report.pdf', 'daybook.store', 'daybook.update', 'daybook.destroy', 'daybook.petty-cash') ? 'active' : '' }}" href="{{ route('daybook.index') }}"><i class="bi bi-journal-text app-sidebar-link__icon" aria-hidden="true"></i><span>DayBook</span></a>
                    <a class="app-sidebar-link app-sidebar-link--sub {{ request()->routeIs('daybook.ledger', 'daybook.ledger.pdf') ? 'active' : '' }}" href="{{ route('daybook.ledger') }}"><i class="bi bi-journal-bookmark app-sidebar-link__icon" aria-hidden="true"></i><span>Ledger</span></a>
                    ...
                    <a class="app-sidebar-link app-sidebar-link--sub {{ request()->routeIs('sale.files.sale.create') && (int) optional(request()->route('projectFile'))->id === 3 && request('type') === 'percentage' ? 'active' : '' }}" href="{{ route('sale.files.sale.create', ['projectFile' => 3, 'type' => 'percentage']) }}"><i class="bi bi-percent app-sidebar-link__icon" aria-hidden="true"></i><span>Sale percentage</span></a>
                </nav>
                @endauth
