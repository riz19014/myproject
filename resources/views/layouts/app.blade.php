        ...
        <aside class="app-sidebar" id="appSidebar" aria-label="Main navigation">
            <div class="app-sidebar-inner">
                ...
                <nav class="app-sidebar-nav">
                    ...
                    <a class="app-sidebar-link {{ request()->routeIs('sale-land.index', 'lands.*') ? 'active' : '' }}" href="{{ route('sale-land.index') }}"><i class="bi bi-geo-alt app-sidebar-link__icon" aria-hidden="true"></i><span>Sale Land</span></a>
