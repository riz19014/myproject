        ...
        <aside class="app-sidebar" id="appSidebar" aria-label="Main navigation">
            <div class="app-sidebar-inner">
                ...
                <nav class="app-sidebar-nav">
                    ...
                    <a class="app-sidebar-link {{ request()->routeIs('purchase.index', 'purchase.records.*') || $sidebarIsPurchaseProject ? 'active' : '' }}" href="{{ route('purchase.index') }}"><i class="bi bi-bag-check app-sidebar-link__icon" aria-hidden="true"></i><span>Purchase</span></a>
