        ...
        <form action="{{ route('lands.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control form-control-theme @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. 3 Kanal Block A" required>
                    @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6 mb-3">
                    <label for="total_area_kanal" class="form-label">Total Area (Kanal)</label>
                    <input type="number" step="0.01" class="form-control form-control-theme" id="total_area_kanal" name="total_area_kanal" value="{{ old('total_area_kanal') }}" placeholder="e.g. 3">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
            ...
            <button type="submit" class="btn btn-pink">Add Land</button>
        </form>
    </div>
</div>
@endsection
