            ...
            <div class="mb-4">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-2">
                    <div>
                        ...
                        <p class="text-muted small mb-0">Select one or more dealer / agent parties for this file.</p>
                    </div>
                ...
                <div id="purchase_file_dealers_list" class="border rounded p-3 @if($parties->isEmpty()) d-none @endif" style="max-height: 240px; overflow-y: auto;">
                    @foreach($parties as $party)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="dealer_party_ids[]" value="{{ $party->id }}" id="dealer_{{ $party->id }}" @checked(in_array($party->id, old('dealer_party_ids', [])))>
