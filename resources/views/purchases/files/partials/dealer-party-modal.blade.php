...
<div class="modal fade" id="purchaseFileAddDealerModal" tabindex="-1" aria-labelledby="purchaseFileAddDealerModalLabel" aria-hidden="true" data-bs-focus="false">
        ...
        <div class="modal-content" style="background: var(--card-bg); border: 1px solid var(--border-dark); color: var(--text-dark);">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6 party-sc-combo" id="pf_dealer_sc_wrap">
            ...
            <div class="modal-footer border-secondary flex-nowrap gap-2">
                ...
                <button type="button" class="btn btn-pink flex-grow-1 flex-sm-grow-0" id="pf_dealer_save_btn">
