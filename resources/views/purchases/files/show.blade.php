    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="small text-muted mt-3 mb-0">Each selected seller and buyer gets a separate signature block. The logged-in user’s role, name, and signature are always included.</p>
            </div>
